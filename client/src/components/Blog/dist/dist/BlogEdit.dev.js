...
function PostEdit() {
  ...
  var _b = react_1.useState(true),
      auth = _b[0],
      setAuth = _b[1]; //replace with real Auth later
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , axios_1["default"].post(window.location.pathname, formValue)];
  ...
  return React.createElement("div", null, React.createElement(React.Fragment, null, React.createElement("div", {
    className: "grid grid-cols-5 p-5 "
  }, React.createElement("i", null), React.createElement("form", {
    onSubmit: handleSubmit,
    className: "text-custom-green-blue border border-custom-silver text-center col-span-3"
  }, React.createElement("div", {
    className: "text-lg pt-5"
  }, "Please Edit Your Post."), React.createElement("div", {
    className: "p-2 m-10"
    ...
    maxLength: 750
  }, " ")), messagePosted ? React.createElement(SuccessMessage, null) : null, React.createElement("div", {
    className: "p-2 m-2"
  ...
  }, "Submit"))), React.createElement("i", null))));
}
